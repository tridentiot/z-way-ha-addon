...
This add-on starts Trident IoT Z-Way server in a supervised Home Assistant (HAOS), Home Assistant Yellow and Green.
...
After installing this add-on, add [Trident IoT intergration](https://www.home-assistant.io/integrations/zwave_me) to your Home Assistant to integrate devices present in Z-Way in Home Assistant UI.
...
Home inforation about Z-Way can be found on the [Trident IoT web site](https://tridentiot.com/technology/zwave/).

[Z-Way manual](https://tridentiot.github.io/z-way-developer-documentation/)
